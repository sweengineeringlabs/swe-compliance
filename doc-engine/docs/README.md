...
doc-engine is a Rust CLI tool and library that audits project documentation against the 50 compliance checks defined by the template-engine documentation framework.
