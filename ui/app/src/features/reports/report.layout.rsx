    ...
    render {
        <section class="reports-layout" data-testid="reports-layout" aria-label="Reports & Export">
            <header class="reports-layout__header">
                <div>
                    <h1 class="reports-layout__heading" data-testid="reports-heading">"Reports & Export"</h1>
                    <p class="reports-layout__description">"Generate and export compliance reports in multiple formats."</p>
                </div>
            </header>
